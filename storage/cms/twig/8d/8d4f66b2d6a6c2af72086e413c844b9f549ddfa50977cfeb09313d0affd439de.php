...
/* C:\mamp\htdocs\brian-jacobs-golf/themes/bjg/pages/instruction.htm */
class __TwigTemplate_f1fa57c540783b65ffd45f1a687a63ecba467dd3b90fd4b93fcd0e948fc785d1 extends Twig_Template
{
...
\t\t\t<!--<div class=\"col-md-4\">
\t\t\t\t<h4>TrackMan</h4>
\t\t\t\t<p>Trackman, the industry-leading swing and ball flight analysis system, takes our teaching to a new level. You'll find out how technology can help you become a better player.</p>
\t\t\t</div>

\t\t\t<div class=\"col-md-4\">
\t\t\t\t<h4>Premier Equipment</h4>
\t\t\t\t<p>We believe in equipping students with the best possible tools for playing the game. Our partnerships provide discounts for students to get the equipment that fits their game.</p>
\t\t\t</div>

\t\t\t<div class=\"col-md-4\">
\t\t\t\t<h4>Eyeline Golf</h4>
\t\t\t\t<p>Partnering with Eyeline Golf gives our students access to premier putting instruction methodologies and tools to turn putting into a strength of their game.</p>
\t\t\t</div>-->
\t\t</div>
...
\t\t\t\t<p>When we know our students and what their goals are, we can develop a <em>tailored plan</em> for improvement and sustained success. We don't give lessons, we provide <em>coaching</em>. We want to identify areas of improvement and continually work together toward those goals.</p>
\t\t\t</div>

\t\t\t<div class=\"col-md-4\">
\t\t\t\t<h4>Reinforce Instruction</h4>
...
\t\t\t\t<div class=\"callout__body\">
\t\t\t\t\t<div class=\"callout__content\">
\t\t\t\t\t\t<h3 class=\"callout__title\">Flex</h3>
\t\t\t\t\t\t<ul>
...
\t\t\t\t\t<a href=\"";
        // line 178
        echo $this->env->getExtension('CMS')->pageFilter("new-students");
        echo "\">Learn More</a>
...
\t\t\t\t\t<a href=\"";
        // line 190
        echo $this->env->getExtension('CMS')->pageFilter("group-clinics");
        echo "\">Learn More</a>
\t\t\t\t\t<a href=\"http://brianjacobsgolf.uschedule.com/OnlineAppointments.aspx\" target=\"_blank\">Book Now</a>
\t\t\t\t</div>
\t\t\t</div>
...
\t\t\t\t\t<a href=\"";
        // line 202
        echo $this->env->getExtension('CMS')->pageFilter("tour-experience");
        echo "\">Learn More</a>
\t\t\t\t\t<a href=\"http://brianjacobsgolf.uschedule.com/OnlineAppointments.aspx\" target=\"_blank\">Book Now</a>
\t\t\t\t</div>
\t\t\t</div>
...
\t</div>
    ...
    {
        return "C:\\mamp\\htdocs\\brian-jacobs-golf/themes/bjg/pages/instruction.htm";
    }
    ...
    {
        return array (  228 => 202,  213 => 190,  198 => 178,  19 => 1,);
    }
}
/* <section>*/
/* 	<div class="container">*/
...
/* 				</div>*/
/* 				<div class="card__footer">*/
/* 					<a href="{{ 'new-students'|page }}">Learn More</a>*/
/* 					<a href="http://brianjacobsgolf.uschedule.com/OnlineAppointments.aspx" target="_blank">Book Now</a>*/
/* 				</div>*/
/* 			</div>*/
/* */
...
/* 				</div>*/
/* 				<div class="card__footer">*/
/* 					<a href="{{ 'group-clinics'|page }}">Learn More</a>*/
/* 					<a href="http://brianjacobsgolf.uschedule.com/OnlineAppointments.aspx" target="_blank">Book Now</a>*/
/* 				</div>*/
/* 			</div>*/
/* */
...
/* 				</div>*/
/* 				<div class="card__footer">*/
/* 					<a href="{{ 'tour-experience'|page }}">Learn More</a>*/
/* 					<a href="http://brianjacobsgolf.uschedule.com/OnlineAppointments.aspx" target="_blank">Book Now</a>*/
/* 				</div>*/
/* 			</div>*/
/* 		</div>*/
